...
V2: engere Rohphrasen-Extraktion, kein Satz-Fallback, kein Goldstandard-Hardcoding

Input:
    C:\xampp\htdocs\lcn\data2bs\data2lcn_db\mapping_drs2treats\006\01_batches\blog\txt\blog_0001.txt

Outputs:
    C:\xampp\htdocs\lcn\data2bs\data2lcn_db\mapping_drs2treats\006\05_py_matching\results\match_blog_0001_v2.csv
    C:\xampp\htdocs\lcn\data2bs\data2lcn_db\mapping_drs2treats\006\05_py_matching\results\match_blog_0001_v2_debug.json
"""
...
OUTPUT_CSV = OUTPUT_DIR / "match_blog_0001_v2.csv"
OUTPUT_DEBUG_JSON = OUTPUT_DIR / "match_blog_0001_v2_debug.json"
...
# Engere Patterns: nur echte Match-Spans, kein ganzer Satzrest
ACTION_PATTERNS = [
    # Hopf-Seidel / Diagnose / Behandlung
...
def local_fragments_for_provider(section: str, provider: str) -> List[str]:
    """
    Lokal = derselbe Ursache-Abschnitt.
    """
...
def normalize_provider_name(provider: str) -> str:
    """
    Wichtigster Alias-Fix für V2:
    'Dr. Theuerkauf' -> 'Dr. Birgitt Theuerkauf'
    """
...
def normalize_candidate(raw_phrase: str, section_heading: str) -> List[str]:
    ...
    # 1) Diagnose + Behandlung einer akuten/chronischen Krankheit
    if re.search(r"\bDiagnose\b", phrase, re.I) and re.search(r"\bBehandlung\b", phrase, re.I):
    ...
    # 4) Behandlung einzelner Krankheit
