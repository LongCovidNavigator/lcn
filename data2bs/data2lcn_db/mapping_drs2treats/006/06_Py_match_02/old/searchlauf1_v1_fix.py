...
MEDICAL_TRIGGER_PATTERNS: Sequence[Tuple[str, str]] = (
    ...
    # Diagnosen
    (r"\b(?:ME/CFS|CFS|Long Covid|Post Vac|PostVac|POTS|Hashimoto(?:-Thyreoiditis)?|Borreliose|Anämie|HPU|HIV|Mitochondriopathie|Hypothyreose|Autoimmunerkrankung(?:en)?|Histamin-Intoleranz|Histamin-Unverträglichkeit|Leaky Gut(?: Syndrom)?|Nebenniereninsuffizienz|Diabetes|Hyperkalzämie)\b", "diagnosis"),
    (r"\b(?:Syndrom|Erkrankung|Störung|Insuffizienz|Entzündung|Tumorerkrankung|Schwäche)\b", "diagnosis"),
    # Treatments
